...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the SponsorLine web console.
...
- Per-env Cloudflare Pages projects: `sponsorline-web-console-next-{dev,stage,prod}`
