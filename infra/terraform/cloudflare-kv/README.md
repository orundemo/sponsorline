...
| `orgName` | string | `sponsorline` | Org identifier |
| `owner` | string | `sponsorline` | GitHub owner |
| `repo` | string | `sponsorline` | GitHub repo |
| `namespace` | string | `sponsorline` | Logical namespace |
