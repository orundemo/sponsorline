...
//   - SponsorLineError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): SponsorLine {
  return new SponsorLine({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the SponsorLine class", () => {
