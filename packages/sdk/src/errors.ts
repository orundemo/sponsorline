// Typed error hierarchy for the SponsorLine SDK.
//
...
// codes (forward compatibility) fall back to the generic `SponsorLineError`
...
export interface SponsorLineErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof SponsorLineError`
 * still matches.
 */
export class SponsorLineError extends Error {
  ...
  constructor(init: SponsorLineErrorInit) {
    super(init.envelope.message);
    this.name = "SponsorLineError";
...
export class BadRequestError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class UnauthenticatedError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class ForbiddenError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class NotFoundError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class ConflictError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class ValidationError extends SponsorLineError {
...
export class PreconditionFailedError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class UnsupportedError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export class InternalError extends SponsorLineError {
  constructor(init: SponsorLineErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends SponsorLineErrorInit {
...
export class RateLimitError extends SponsorLineError {
...
/**
 * Decode an HTTP `Response` into the appropriate `SponsorLineError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `SponsorLineError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new SponsorLineError(init);
  }
}

function decodeRateLimit(
  init: SponsorLineErrorInit,
  response: Response,
): RateLimitError {
