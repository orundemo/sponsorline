 ...
 * signature verifier for SponsorLine outbound webhook deliveries.
 *
...
/**
 * Compute the canonical SponsorLine webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a SponsorLine webhook delivery.
 *
