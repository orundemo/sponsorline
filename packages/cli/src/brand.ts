...
// `@saas/sdk` client class name (`SponsorLine`) is intentionally NOT part of
...
export const CLI_BIN = "sponsorline";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "SponsorLine";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.sponsorline.dev";
