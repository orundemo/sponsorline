// `sponsorline whoami` — read token + cached context, validate via SDK.
...
export interface WhoamiInput {
  ...
  /** SDK factory override for tests. Defaults to constructing `SponsorLine`. */
  readonly sdkFactory?: (baseUrl: string, token: string) => SponsorLine;
}
