...
//   - `~/.config/sponsorline/credentials.json` (0600)
//   - `~/.config/sponsorline/config.json`     (0644)
//
// Override via `SPONSORLINE_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/sponsorline` everywhere
