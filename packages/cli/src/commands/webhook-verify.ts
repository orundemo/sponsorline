// `sponsorline webhook verify` — local cryptographic verification of a
// SponsorLine outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `sponsorline login`.
